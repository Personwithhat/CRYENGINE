...
namespace UQS
{
	namespace Core
	{
		...
		struct SCvars
		{
			...
			static CTimeValue    timeBudgetInSeconds;                              // granted time in seconds to update all running queries in a time-sliced fashion
			...
			static mpfloat       timeBudgetExcessThresholdInPercent;               // percentage of the granted time of a query that we allow to exceed before taking counter-measures and issuing warnings

...
namespace UQS
{
	namespace Core
	{
		...
		struct SCvars
		{
			...
			static mpfloat       timeBudgetExcessThresholdInPercentBeforeWarning;  // percentage of the granted time of a query that we allow to exceed before issuing a warning

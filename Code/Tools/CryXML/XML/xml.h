...
public:
	...
	// PERSONAL TODO: Can't get this stupid thing to compile. Keeps saying unresolved external symbol gEnv!!! Note: When changing stuff here to an RC rebuild otherwise it will ignore.

...
public:
	...
	void  SetVideoScale(int axis, const mpfloat& offset);
	const mpfloat& GetVideoScale(int axis) const;
	void  SetVideoOffset(int axis, const mpfloat& offset);
	const mpfloat& GetVideoOffset(int axis) const;

...
#include "QPropertyTreeLegacy.h"
#include "Serialization/PropertyTreeLegacy/IUIFacade.h"
#include "Serialization/PropertyTreeLegacy/PropertyTreeModel.h"
#include "Serialization/PropertyTreeLegacy/PropertyRowNumberField.h"
#include "Serialization/PropertyTreeLegacy/MathUtils.h"
...
class InplaceWidgetNumber : public QObject, public property_tree::InplaceWidget
{
	Q_OBJECT
public:
	inline InplaceWidgetNumber(PropertyRowNumberField* numberField, QPropertyTreeLegacy* tree);
...
InplaceWidgetNumber::InplaceWidgetNumber(PropertyRowNumberField* row, QPropertyTreeLegacy* tree)
: InplaceWidget(tree)
, row_(row)

...
#include <Serialization/PropertyTreeLegacy/PropertyRowNumber.h>
...
#include <QToolBar>
#include <QLabel>
#include "Serialization/QPropertyTreeLegacy/QDrawContext.h"
...
bool PropertyRowCurve::onContextMenu(IMenu& menu, PropertyTreeLegacy* tree)
{
...
void PropertyRowCurve::editCurve(PropertyTreeLegacy* tree)
{
	if (!tree_ && tree)
	{
	...
	if (QWidget* widget = static_cast<QPropertyTreeLegacy*>(tree))
	{

...
struct IRenderer//: public IRendererCallbackServer
{
	...
	/////////////////////////////////////////////////////////////////////////////////
	virtual bool EF_PrecacheResource(ITexture* pTP, float fMipFactor, const CTimeValue& fTimeToReady, int Flags, int nUpdateId) = 0;
	...
	virtual bool EF_PrecacheResource(IRenderShaderResources* pShaderResources, float fMipFactor, const CTimeValue& fTimeToReady, int Flags, int nUpdateId) = 0;
	virtual bool EF_PrecacheResource(IRenderShaderResources* pShaderResources, int iScreenTexels, const CTimeValue& fTimeToReady, int Flags, int nUpdateId) = 0;
	virtual bool EF_PrecacheResource(SShaderItem* pSI, int iScreenTexels, const CTimeValue& fTimeToReady, int Flags, int nUpdateId) = 0;
	virtual bool EF_PrecacheResource(SShaderItem* pSI, float fMipFactor, const CTimeValue& fTimeToReady, int Flags, int nUpdateId) = 0;
	virtual bool EF_PrecacheResource(IShader* pSH, float fMipFactor, const CTimeValue& fTimeToReady, int Flags, int nUpdateId) = 0;
	...
	struct SRenderTimes
	{
		...
		CTimeValue fWaitForGPU_MT;
		CTimeValue fWaitForGPU_RT;

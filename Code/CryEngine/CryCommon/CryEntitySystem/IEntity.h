...
struct SEntityUpdateContext
{
	...
	CTimeValue  fCurrTime; // PERSONAL IMPROVE: Should probably be renamed to startTime or something? Along with other 'fXXX' variables/function-params.
...
public:
	...
	virtual void SetTimer(ISimpleEntityEventListener* pListener, EntityId id, const CryGUID& componentInstanceGUID, uint32 timerId, const CTimeValue& inTime) = 0;
...
inline void IEntityComponent::SetTimer(uint32 timerId, const CTimeValue& time)
{

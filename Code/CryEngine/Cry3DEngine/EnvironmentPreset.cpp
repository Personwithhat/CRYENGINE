...
static const int sAnimTimeSecondsIn24h = 24;   // 24 hours = (sAnimTimeSecondsIn24h * SAnimTime::numTicksPerSecond) ticks

static const mpfloat sBezierSplineKeyValueEpsilon = "0.001";
}

...
public:
	...
	void                                   RasterWindAreas(std::vector<SOptimizedOutdoorWindArea>* pWindAreas, const CTimeValue& fElapsedTime);
	void                                   RasterGlobalWind(const Vec3& vGlobalWind, const CTimeValue& fElapsedTime, bool bReset);
...
#define MAX_LIGHTS_NUM 32
	...
	CTimeValue                             m_fLastWindProcessedTime = 0;

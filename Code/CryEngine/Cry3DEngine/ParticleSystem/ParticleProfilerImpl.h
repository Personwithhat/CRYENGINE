...
ILINE CTimeProfiler::~CTimeProfiler()
{
	...
	// Float inaccuracy is fine, debug/profiling:   PERSONAL IMPROVE: Although this can perhaps be improved.
	const uint time = uint(GetGTimer()->TicksToTime(endTicks - m_startTicks).GetSeconds() * 1000000);

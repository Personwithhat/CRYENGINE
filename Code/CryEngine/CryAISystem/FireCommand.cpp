                                                 ...
                                                 Vec3& aimTarget, bool canFire)
{
	...
	CTimeValue drawTime = gAIEnv.CVars.legacyFiring.DrawFireEffectTimeScale * descriptor.drawTime;
                                         ...
                                         const float minimumDistanceToFriendsSq) const
{
	...
	if (eRGT_SMOKE_GRENADE != eReqGrenadeType)
	{
		...
		const CTimeValue timePrediction = gAIEnv.CVars.legacyFiring.LobThrowTimePredictionForFriendPositions;

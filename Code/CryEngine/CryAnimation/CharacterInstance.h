...
public:
	...
	void ResetQuasiStaticSleepTimer()
	{
		...
		{
			m_quasiStaticSleepTimer = Console::GetInst().ca_QuasiStaticAnimationSleepTimeout;
		}
		else
		{
			m_quasiStaticSleepTimer.SetSeconds(-1);
		}
	}
	...
	bool IsQuasiStaticSleeping()
	{
		...
		const bool bHasTimerExpired = m_quasiStaticSleepTimer <= 0;
...
private:
	...
	CTimeValue m_quasiStaticSleepTimer = 0;

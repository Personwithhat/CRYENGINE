...
public:
	...
	void                     DestroyPhysics();
	void                     SetAuxParams(pe_params* pf);
	void                     BuildPhysicalEntity(IPhysicalEntity* pent, f32 mass, int surface_idx, f32 stiffness_scale, int nLod = 0, int partid0 = -1, const Matrix34& mtxloc = Matrix34(QuatT(IDENTITY)));

...
private: // ----------------------------------------------------------
	...
	virtual ICVar* RegisterTime(const char* sName, const CTimeValue& fValue, int nFlags, const char* help = "", ConsoleVarFunc pChangeFunc = 0) override;
	virtual ICVar* Register(const char* name, CTimeValue* src, const CTimeValue& defaultvalue, int nFlags = 0, const char* help = "", ConsoleVarFunc pChangeFunc = 0, bool allowModify = true) override;
